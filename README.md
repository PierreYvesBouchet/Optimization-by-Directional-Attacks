...
#### ResNet18 problem
To run the proof-of-concept problem based on ResNet18, the torchvision module must be installed. More precisely, we load the model using the Python command
```from torchvision.models.resnet import ResNet18_Weights```

However, the dataset of images used in the problem must be downloaded manually. It is available at [this link](https://github.com/EliSchwartz/imagenet-sample-images). After downloading the 1000 images, set them (the images directly, not the .zip file) at the location
```
problems/
...
Second, download the models themselves. The CNN is available at [this link](https://github.com/GermainVivierArdisson/CF-OPT/tree/main/models/cnn_model_saves) (download CNN_MSE_epoch_100.pth). The VAE is given at [this link](https://github.com/GermainVivierArdisson/CF-OPT/tree/main/models/vae_model_saves) (download VAE_64_epoch_35.pth). Then, set these two models at the location
```
problems/
	warcraft_map_counterfactual/
		problem/
			build_data/
```
